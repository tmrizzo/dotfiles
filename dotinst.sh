#!/bin/sh
ln -vsf ~/git/dotfiles/fonts/ ~/.fonts
...
ln -vsf ~/git/dotfiles/vim/ ~/.vim
ln -vsf ~/git/dotfiles/vimrc ~/.vimrc
ln -vsf ~/git/dotfiles/Xresources ~/.Xresources
ln -vsf ~/git/dotfiles/gitconfig ~/.gitconfig
